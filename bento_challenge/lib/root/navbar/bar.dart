...
const double ACTION_LAYOUT_SIZE = 80;

/// Default size for active icon in tab.
const double ACTION_INNER_BUTTON_SIZE = 20;
...
class ConvexAppBarState extends State<ConvexAppBar> with TickerProviderStateMixin {
  ...
  Widget _newTab(int i, bool active) {
    ...
    return ScaleTransition(
        scale: _currentIndex == i ? _scaleAnimation : const AlwaysStoppedAnimation(1.0),
        child: widget.chipBuilder?.build(context, child, i, active) ?? child);
  }
